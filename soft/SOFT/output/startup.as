	...
	; Compiler options:
	;
	; -oSC8F3752.cof -mSC8F3752.map --summary=default,-psect,-class \
	; --fill=0xFFFF --output=intel function.p1 function_work.p1 main.p1 \
	; mcu_adc.p1 mcu_config.p1 mcu_gpio.p1 mcu_int.p1 mcu_pwm.p1 \
	; mcu_timer.p1 struct.p1 --chip=SC8F3752 -P --runtime=default, \
